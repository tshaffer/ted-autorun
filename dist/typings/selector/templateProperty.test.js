...
describe('templateProperty - selector', function () {
    var testStateOne = {
        template: {
            property: {
                color: {
    ...
    it('should retrieve template property color state', function () {
    ...
    it('should retrieve template property state', function () {
