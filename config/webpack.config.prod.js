...
module.exports = {
  ...
  output: {
    ...
    devtoolModuleFilenameTemplate: info =>
      path
        .relative(paths.appProdSrc, info.absoluteResourcePath)
        .replace(/\\/g, '/'),
  },
  resolve: {
    ...
    plugins: [
      ...
      new ModuleScopePlugin(paths.appProdSrc, [paths.appPackageJson]),
    ],
  },
  module: {
      ...
      },
      {
        ...
        oneOf: [
          ...
          // assets smaller than specified size as data URLs to avoid requests.
          {
            ...
            options: {
              limit: 1000000,//TODO fix this for electron and web case
