...
if (!checkRequiredFiles([paths.appHtml, paths.appStandaloneIndexJs])) {
  process.exit(1);
}
...
checkBrowsers(paths.appPath, isInteractive)
  ...
  .then(port => {
    ...
    devServer.listen(port, HOST, err => {
      ...
      if (envVar.raw.FAST_REFRESH && semver.lt(react.version, '16.10.0')) {
        console.log(
          chalk.yellow(
      ...
      const isElectron = envVar.raw.PLATFORM === 'electron';
